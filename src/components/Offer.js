...
function Offer() {
  return (
    <div className='flex flex-col container bg-blue-200 rounded-md p-1 w-96'>
    ...
    <hr className='border-1 w-full'/>
        ...
        <h1 className="font-bold text-green-600 mb-1">4.Buy a Butter alone or with Milk to get a Discount of £0.2</h1>
        </div>
